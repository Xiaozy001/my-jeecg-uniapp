			...
			<view class="cu-bar tabbar bg-white">
				<view class="action">
					<view class="cuIcon-cu-image">
						<image src="https://www.xzyfh.top/appimgs/static/tabbar/basics_cur.png"></image>
					</view>
					<view class="text-green">元素</view>
				</view>
				<view class="action">
					<view class="cuIcon-cu-image">
						<image src="https://www.xzyfh.top/appimgs/static/tabbar/component.png"></image>
					</view>
					<view class="text-gray">组件</view>
				</view>
				<view class="action">
					<view class="cuIcon-cu-image">
						<image src="https://www.xzyfh.top/appimgs/static/tabbar/plugin.png"></image>
				...
				<view class="action">
					<view class="cuIcon-cu-image">
						<image src="https://www.xzyfh.top/appimgs/static/tabbar/about.png"></image>
